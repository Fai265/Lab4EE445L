/***************************************************
  ...
  MIT license, all text above must be signluded in any redistribution
 ****************************************************/
...
void ST7735_DrawBitmap(int16_t x, int16_t y, const uint16_t *image, int16_t w, int16_t h){
  ...
  if((w > _width) || (h > _height)){    // image is too wide for the screen, do nothing
    ...
    //following logic much more complicated, ssigne you can have
...
// Returns X position used for things like
// outchar and outstring
int Return_XPos(void){
	return StX;
}

// Returns Y position used for things like
// outchar and outstring
...
//	if(x1 > x2 && y1 < y2){	//first point is to the upper right of the second
//		int dx = x1 - x2;
//		int dy = y2 - y1;
//		int D = 2*dy - dx;
//		int y = y1;
...
//	if(x1 > x2 && y1 > y2){	//first point is to the lower right of the second
//		int dx = x1 - x2;
//		int dy = y1 - y2;
//		int D = 2*dy - dx;
//		int y = y1;
...
//	if(x1 < x2 && y1 < y2){	//first point is to the upper left of the second
//		int dx = x2 - x1;
//		int dy = y2 - y1;
//		int D = 2*dy - dx;
//		int y = y1;
...
//	if(x1 < x2 && y1 > y2){	//first point is to the lower left of the second
//		int dx = x2 - x1;
//		int dy = y1 - y2;
//		int D = 2*dy - dx;
//		int y = y1;
